...
namespace DT102G_ASP_NET_Moment3.Controllers
{
    public class RecordsController : Controller
    {
        ...
        {
            //If search is null or empty get all records(CDs) else
            //Get those that match the cd name
            var artistContext = string.IsNullOrEmpty(search)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecordId,Name,ReleasedYear,NrOfTunes,TotalLength,Created,ArtistId")] Record record)
        {
